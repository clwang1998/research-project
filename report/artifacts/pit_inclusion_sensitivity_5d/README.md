...
```json
{
  "selected_run_dir": "output/model_search/route_b_factor_residual_alpha_core_20260622__target_excess_sector_fwd_5d__tabular__xgboost__xgb_balanced",
  ...
  "excluded_holdout_rows_after_baseline_controls": 28367,
