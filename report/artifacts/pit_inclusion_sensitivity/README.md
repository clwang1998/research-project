...
```json
{
  "selected_run_dir": "output/model_search/route_b_factor_residual_alpha_core_20260622__target_excess_sector_fwd_30d__tabular__xgboost__xgb_balanced",
  "target_col": "target_excess_sector_fwd_30d",
  "return_col": "target_ret_fwd_30d",
